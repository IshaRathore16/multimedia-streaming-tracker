...
export default function Home() {
  ...
  return (
    <div className="flex flex-col md:px-12 px-0 relative bg-background  font-poppins items-center min-h-screen">
      <h1 className=" font-bold text-6xl text-active mt-20">
      ...
      >
        ...
        <div className="mt-4 sm:mt-0 sm:ml-3">
          <button
            className="block w-full rounded-lg px-5 py-3 bg-active text-base text-danger font-bold focus:outline-none focus:ring-2 focus:ring-primary sm:px-10"
            type="submit"
          >
